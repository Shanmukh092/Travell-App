...
import UserActions from '../../Components/drop-down/UserActions'
import UserDetails from '../../Components/drop-down/UserDetails'
const Home = () => {
  const [allHotels,setAllHotels] = useState([])
  const {state} = useCategoryContex();
  const contex = useDate();
  const {isLoggedIn} = useAuth()
  const {openWishList,isDetailsOpen} = useActions();
